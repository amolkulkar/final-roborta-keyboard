...
def main():
    ...
    ap.add_argument("--dataset", default=None, help="CSV/JSONL with text(+label optional)")
    ...
    texts = _iter_dataset(args.dataset, args.limit) if args.dataset else (
        SAMPLES if args.limit is None else SAMPLES[: args.limit]
    )
